...
/*-----------------------------------------------------------------------------------*/
	...
	array(
		...
		'description' => __('Check the box to hide the entire header and navigation bars on this Page.', 'themebeagle'),
		'default' => '',
	),
...
/*-----------------------------------------------------------------------------------*/
	...
	array(
		...
		'description' => __('Check the box to use the Unboxed/Wide layout on this Page.', 'themebeagle'),
		'default' => '',
	),
...
/*-----------------------------------------------------------------------------------*/
	...
	array(
		...
		'description' => __('Check the box to display the Featured Slides slider at the top of this Page.', 'themebeagle'),
		'default' => '',
	),
